use utf8;
package MouseSOM::Schema::Result::GenesBnorm;
...
=head1 TABLE: C<genes_bnorm>

=cut

__PACKAGE__->table("genes_bnorm");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Oc4DM79eXmpzjxR4Vbv1sQ
