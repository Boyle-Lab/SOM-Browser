use utf8;
package MouseSOM::Schema::Result::PosPeak;
...
=head1 TABLE: C<pos_peaks>

=cut

__PACKAGE__->table("pos_peaks");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FdyOFELm9CvKr3DJ+A2hCA
