use utf8;
package MouseSOM::Schema::Result::GoNeuron;
...
=head1 TABLE: C<go_neurons>

=cut

__PACKAGE__->table("go_neurons");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1m/LdQfcenlNAv3e8tLyKA
