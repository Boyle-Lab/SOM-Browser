use utf8;
package MouseSOM::Schema::Result::BgPeaksGene;
...
=head1 TABLE: C<bg_peaks_genes>

=cut

__PACKAGE__->table("bg_peaks_genes");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iUtIOB43VFocgqQo1NlcUg
